    ...
    namespace solvers{
        ...
        class Quick_solver{
            ...
            public:
                ...
                int ad_dyn(float beta_max, float rho_max, float b, float q, float d, float alpha, float gamma, float c1, float c2, float delta_Q, float eta, float delta, int seed, int rho_init, float S_density, float Q_density, float Adensity, float U_density, int evo_steps, int trait_space_length);
                void eco_dynamics(float* S, float* Q, float* A, float* U, float* R, float beta_value, float rho_value, float b, float q, float d, float alpha, float gamma, float c1, float c2, float delta_Q, float eta, float delta, int seed, float S_density, float Q_density, float A_density, float U_density);
        };
    }
