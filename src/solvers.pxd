...
cdef extern from "wrapper.h" namespace "solvers":
    cdef cppclass Quick_solver:
        ...
        void eco_dynamics(float*, float*, float*, float*, float*, float*, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, int, float, float, float, float, float)
