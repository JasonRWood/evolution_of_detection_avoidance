...
plt.savefig(f"../outputs/heatmap_prerfect_both_with_C_check.png", bbox_inches = "tight")
plt.savefig(f"../outputs/heatmap_prerfect_both_with_C_check.pdf", bbox_inches = "tight")
plt.close()