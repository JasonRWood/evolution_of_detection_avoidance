...
ax[1][2].plot([zeta_threshold_model_C, zeta_threshold_model_C], [0, R0_upper_limit], "k--")
# if delta == 0 and eta == 1.0:
...
plt.savefig("../outputs/evolution_Models_perfect.png", bbox_inches = "tight")
plt.savefig("../outputs/evolution_Models_perfect.pdf", bbox_inches = "tight")
plt.close()